...
def write_data_to_excel(dut_info,test_summary,test_result,excel_path=Path('./summary_autoit.xlsx')):
    ...
    for test_case in list(test_result.keys()):
        ...
        if test_case == 'Basic TSI in out(Signalling)' or \
            ...
            set_title_for_sheet('RS485 info by slot',sheet,max_row,6,6,"5cb800")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=6,end_column=6+len(slot_second_name)-1)
            set_title_for_sheet('RS485 info',sheet,max_row,19,19,"5cb800")
            ...
            for i in range(0,len(slot_second_name)):
                set_title_for_sheet(slot_second_name[i],sheet,max_row+1,6+i,6+i,"5cb800")
            for i in range(0,len(sta_second_name)):
                set_title_for_sheet(sta_second_name[i],sheet,max_row+1,19+i,19+i,"5cb800")
            # --- merge ---
            for i in range(1,6):
            ...
            for x, RS485_item in enumerate(test_result[test_case]):
                    ...
                    for ind,(key,val) in enumerate(item.items()):
                        if len(item) > 6:
                            if ind == 0:
                                ...
                                if dut_num:
                                    sheet.cell(index1+count-minus_count-1,6).value = int(dut_num.group(1))
                                if slot_num:
                                    sheet.cell(index1+count-minus_count-1,7).value = int(slot_num.group(1))
                                elif slot_abc:
                                    sheet.cell(index1+count-minus_count-1,7).value = slot_abc.group(1)
                            elif ind == 1:
                                info_data = F"{val}"
                                sheet.cell(index1+count-minus_count-1,8).value = float(info_data)
                            elif ind == 2:
                                info_data = F"{val}"
                                ...
                                if float(info_data) != 0.0:
                                    sheet.cell(index1+count-minus_count-1,10).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                            elif ind == 4:
                                info_data = F"{val}"
                                sheet.cell(index1+count-minus_count-1,11).value = float(info_data)
                                if float(info_data) != 0.0:
                                    sheet.cell(index1+count-minus_count-1,11).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                            elif ind == 5:
                                info_data = F"{val}"
                                ...
                                if float(info_data) != 0.0:
                                    sheet.cell(index1+count-minus_count-1,13).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                            elif ind == 7:
                                info_data = F"{val}"
                                ...
                                if float(info_data) != 0.0:
                                    sheet.cell(index1+count-minus_count-1,16).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                            elif ind == 10:
                                info_data = F"{val}"
                                ...
                                info_data = F"{val}"
                                sheet.cell(index1+count-minus_count-1,18).value = info_data
                                if info_data == 'fail':
                            ...
                            if ind == 0:
                                ...
                                dut_num = re.search(r'DUT (\d+)', info_data)
                                if dut_num:
                                    sheet.cell(index1+minus_count,19).value = int(dut_num.group(1))
                            elif ind == 1:
                                info_data = F"{val}"
                                sheet.cell(index1+minus_count,20).value = float(info_data)
                            elif ind == 2:
                                info_data = F"{val}"
                                ...
                                if float(info_data) != 0.0:
                                    sheet.cell(index1+minus_count,22).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                            elif ind == 4:
                                info_data = F"{val}"
                                sheet.cell(index1+minus_count,23).value = info_data
                                if info_data == 'fail':
                ...
                for index3 in range(index1, index1+count-minus_count):
                    for index4 in range(6,sheet.max_column+1):
                        if sheet.cell(index3,index4).fill != PatternFill(start_color="e53b31", fill_type = "solid"):
                ...
                # --- create fail sheet ---
                    ...
                    for count, fail_item in enumerate(RS485_item[info],start=1):
                        if RS485_item[info][count-1]['result'] == 'fail':
                            fail_count += 1
                            ...
                            for ind, (key,val) in enumerate(fail_item.items()):
                                if len(fail_item) > 6:
                                    if ind == 0:
                                        ...
                                        if float(info_data) != 0.0:
                                            wb['F-{}'.format(test_case)].cell(index2-minus_count,9).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 4:
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index2-minus_count,10).value = float(info_data)
                                        if float(info_data) != 0.0:
                                            wb['F-{}'.format(test_case)].cell(index2-minus_count,10).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 5:
                                        info_data = F"{val}"
                                        ...
                                        if float(info_data) != 0.0:
                                            wb['F-{}'.format(test_case)].cell(index2-minus_count,12).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 7:
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index2-minus_count,13).value = float(info_data)
                                        if float(info_data) != 0.0:
                                            wb['F-{}'.format(test_case)].cell(index2-minus_count,13).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 8:
                                        info_data = F"{val}"
                                        ...
                                        if float(info_data) != 0.0:
                                            wb['F-{}'.format(test_case)].cell(index2-minus_count,15).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 10:
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index2-minus_count,16).value = float(info_data)
                                        if float(info_data) != 0.0:
                                            wb['F-{}'.format(test_case)].cell(index2-minus_count,16).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 11:
                                        info_data = F"{val}"
                                    ...
                                    if ind == 0:
                                        ...
                                        if float(info_data) != 0.0:
                                            wb['F-{}'.format(test_case)].cell(index2+minus_count,21).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 4:
                                        info_data = F"{val}"
                    ...
                    if " QE1 " in list(item.values())[0]:
                        for ind,(key,val) in enumerate(item.items()):
                            ...
                            if ind == 0:
                                ...
                                sheet.cell(row_index,6+ind).value = float(val)
                            else:
                                sheet.cell(row_index,6+ind).value = val
            ...
            set_title_for_sheet('Error Counts',sheet,max_row+1,6,6,"5cb800")
            set_title_for_sheet('Error Seconds',sheet,max_row+1,7,7,"5cb800")
            set_title_for_sheet('Result',sheet,max_row+1,8,8,"5cb800")
            # --- merge ---
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=4,end_column=8)
            for i in range(1,4):
                sheet.merge_cells(start_row=1,end_row=2,start_column=i,end_column=i)
            ...
            for i in range(1,6):
                sheet.merge_cells(start_row=1,end_row=2,start_column=i,end_column=i)
            set_title_for_sheet('Ctrl Fail item',sheet,1,6,6,"5cb800")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=6,end_column=9)
            set_title_for_sheet('Time',sheet,2,6,6,"5cb800")
            set_title_for_sheet('Bit Error',sheet,2,7,7,"5cb800")
            set_title_for_sheet('Error ID',sheet,2,8,8,"5cb800")
            set_title_for_sheet('Elapsed Time',sheet,2,9,9,"5cb800")

            set_title_for_sheet('Test Card Fail item',sheet,1,10,1,"5cb800")
            set_title_for_sheet('Time',sheet,2,10,10,"5cb800")
            set_title_for_sheet('PRBS Status',sheet,2,11,11,"5cb800")
            set_title_for_sheet('Error Counts',sheet,2,12,12,"5cb800")
            set_title_for_sheet('Error ID',sheet,2,13,13,"5cb800")
            set_title_for_sheet('Error Seconds',sheet,2,14,14,"5cb800")
            ...
            for vlan_mode,vlan_mode_item in test_result[test_case].items():
                for bundle_ids, bert_item in vlan_mode_item.items():
                    for bert_type,bert_result in bert_item.items():
                        index = sheet.max_row + 1
                        ...
                        merge_row_title_for_sheet(bert_result['pass'],sheet,index,4,index+bert_result['fail']-1,"FFFFFF")
                        merge_row_title_for_sheet(bert_result['fail'],sheet,index,5,index+bert_result['fail']-1,"FFFFFF")
                        bert_fail_data = ''
                        ...
                        # ----- create fail sheet ----- #
                                ...
                                for i in range(1,5):
                                    wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=2,start_column=i,end_column=i)
                                set_title_for_sheet('Ctrl Fail item',wb['F-{}'.format(test_case)],1,5,5,"5cb800")
                                wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=1,start_column=5,end_column=8)
                                set_title_for_sheet('Time',wb['F-{}'.format(test_case)],2,5,5,"5cb800")
                                set_title_for_sheet('Unsync Second',wb['F-{}'.format(test_case)],2,6,6,"5cb800")
                                set_title_for_sheet('Error ID',wb['F-{}'.format(test_case)],2,7,7,"5cb800")
                                set_title_for_sheet('Elapsed Time',wb['F-{}'.format(test_case)],2,8,8,"5cb800")
                                
                                set_title_for_sheet('Test Card Fail item',wb['F-{}'.format(test_case)],1,9,9,"5cb800")
                                set_title_for_sheet('Time',wb['F-{}'.format(test_case)],2,9,9,"5cb800")
                                set_title_for_sheet('PRBS Status',wb['F-{}'.format(test_case)],2,10,10,"5cb800")
                                set_title_for_sheet('Error Counts',wb['F-{}'.format(test_case)],2,11,11,"5cb800")
                                set_title_for_sheet('Error ID',wb['F-{}'.format(test_case)],2,12,12,"5cb800")
                                set_title_for_sheet('Error Seconds',wb['F-{}'.format(test_case)],2,13,13,"5cb800")
            ...
            set_title_for_sheet('Pass',sheet,max_row,4,4,"5cb800")
            set_title_for_sheet('Fail',sheet,max_row,5,5,"5cb800")
            set_title_for_sheet('Working PW',sheet,max_row,6,6,"5cb800")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=6,end_column=6+len(second_name)+len(jitter_name)-2)
            set_title_for_sheet('Standby PW',sheet,max_row,22,22,"5cb800")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=22,end_column=22+len(second_name)+len(jitter_name)-2)
            # --- second row ---
            for i in range(0,4):
                set_title_for_sheet(second_name[i],sheet,max_row+1,6+i,6+i,"5cb800")
            for i in range(4,len(second_name)):
                set_title_for_sheet(second_name[i],sheet,max_row+1,6+len(jitter_name)+i-1,6+len(jitter_name)+i-1,"5cb800")
            for i in range(0,4):
                set_title_for_sheet(second_name[i],sheet,max_row+1,22+i,22+i,"5cb800")
            for i in range(4,len(second_name)):
                set_title_for_sheet(second_name[i],sheet,max_row+1,22+len(jitter_name)+i-1,22+len(jitter_name)+i-1,"5cb800")
            # --- third row ---
            for i in range(len(jitter_name)):
                set_title_for_sheet(jitter_name[i],sheet,max_row+2,9+i,9+i,"5cb800")
            for i in range(len(jitter_name)):
                set_title_for_sheet(jitter_name[i],sheet,max_row+2,25+i,25+i,"5cb800")
            for vlan_mode,vlan_mode_item in test_result[test_case].items():
                for bundle_ids, pw_item in vlan_mode_item.items():
                    for action,pw_result in pw_item.items():
                        index = sheet.max_row + 1
                        sheet.cell(index,1).value = vlan_mode
                        sheet.cell(index,2).value = bundle_ids
                        sheet.cell(index,3).value = action
                        sheet.cell(index,4).value = pw_result['pass']
                        sheet.cell(index,5).value = pw_result['fail']
                        if pw_result['fail'] > 0:
                            sheet.cell(index,5).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                        # --- create fail sheet ---
                            if f'F-{test_case}' not in wb.sheetnames and test_case in ['Bundle test(PW status)']:
                                ...
                                for i in range(4,len(second_name)):
                                    set_title_for_sheet(second_name[i],wb['F-{}'.format(test_case)],max_row+1,4+len(jitter_name)+i-1,4+len(jitter_name)+i-1,"5cb800")
                                for i in range(0,4):
                                    set_title_for_sheet(second_name[i],wb['F-{}'.format(test_case)],max_row+1,20+i,20+i,"5cb800")
                                for i in range(4,len(second_name)):
                                    set_title_for_sheet(second_name[i],wb['F-{}'.format(test_case)],max_row+1,20+len(jitter_name)+i-1,20+len(jitter_name)+i-1,"5cb800")
                                # --- third row ---
                                for i in range(len(jitter_name)):
                                    set_title_for_sheet(jitter_name[i],wb['F-{}'.format(test_case)],max_row+2,7+i,7+i,"5cb800")
                                for i in range(len(jitter_name)):
                                    set_title_for_sheet(jitter_name[i],wb['F-{}'.format(test_case)],max_row+2,23+i,23+i,"5cb800")
                                # --- merge ---
                                for i in range(1,4):
                                    wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=3,start_column=i,end_column=i)
                                for i in range(4,7):
                                ...
                                for i in range(28,36):
                                    wb['F-{}'.format(test_case)].merge_cells(start_row=2,end_row=3,start_column=i,end_column=i)
                                wb['F-{}'.format(test_case)].merge_cells(start_row=2,end_row=2,start_column=7,end_column=11)
                                wb['F-{}'.format(test_case)].merge_cells(start_row=2,end_row=2,start_column=23,end_column=27)
                            fail_count = 0
                                ...
                                if pw_result['Working PW error status'][count-1]['result'] == 'fail':
                                    ...
                                    for ind, (key,val) in enumerate(fail_item.items()):
                                        if ind == 0:
                                            ...
                                            wb['F-{}'.format(test_case)].cell(index1,6).value = (info_data.split())[-1]
                                        elif ind == 1:
                                            info_data = F"{val}"
                                            wb['F-{}'.format(test_case)].cell(index1,7).value = float(info_data)
                                            if float(info_data) != 0.0:
                                                wb['F-{}'.format(test_case)].cell(index1,7).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                        elif ind == 2:
                                            info_data = F"{val}"
                                            ...
                                            info_data = F"{val}"
                                            wb['F-{}'.format(test_case)].cell(index1,9).value = info_data
                                            info_data1 = re.search(r'(\d+\.\d+)', info_data)
                                            if info_data1:
                                                result = float(info_data1.group(1))
                                                if result > 12.0 or result < 4.0:
                                            ...
                                            if float(info_data) > 0.0:
                                                wb['F-{}'.format(test_case)].cell(index1,16).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                        elif ind == 11:
                                            info_data = F"{val}"
                                            wb['F-{}'.format(test_case)].cell(index1,17).value = info_data
                                            if info_data != "up":
                                    ...
                                    wb['F-{}'.format(test_case)].cell(index1,3).value = action
                                    if pw_result['Standby PW error status'][count-1]['result'] == 'fail':
                                        ...
                                        for ind, (key,val) in enumerate(fail_item.items()):
                                            if ind == 0:
                                                ...
                                                ctrl_num = re.search(r'CTRL-(\d+)', info_data)
                                                if dut_num:
                                                    wb['F-{}'.format(test_case)].cell(index1,20).value = float(dut_num.group(1))
                                                if ctrl_num:
                                                    wb['F-{}'.format(test_case)].cell(index1,21).value = float(ctrl_num.group(1))
                                                wb['F-{}'.format(test_case)].cell(index1,22).value = (info_data.split())[-1]
                                            elif ind == 1:
                                                info_data = F"{val}"
                                                wb['F-{}'.format(test_case)].cell(index1,23).value = float(info_data)
                                                if float(info_data) != 0.0:
                                                    wb['F-{}'.format(test_case)].cell(index1,23).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                            elif ind == 2:
                                                info_data = F"{val}"
                                                wb['F-{}'.format(test_case)].cell(index1,24).value = float(info_data)
                                                if float(info_data) != 0.0:
                                                    wb['F-{}'.format(test_case)].cell(index1,24).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                            elif ind == 3:
                                                info_data = F"{val}"
                                                wb['F-{}'.format(test_case)].cell(index1,25).value = info_data
                                                info_data1 = re.search(r'(\d+\.\d+)', info_data)
                                                if info_data1:
                                                    result = float(info_data1.group(1))
                                                    if result > 12.0 or result < 4.0:
                                                        wb['F-{}'.format(test_case)].cell(index1,25).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                            elif ind == 4:
                                                info_data = F"{val}"
                                                ...
                                                info_data = F"{val}"
                                                wb['F-{}'.format(test_case)].cell(index1,28).value = float(info_data)
                                                if float(info_data) != 0.0:
                                                ...
                                                info_data = F"{val}"
                                                wb['F-{}'.format(test_case)].cell(index1,33).value = info_data
                                                if info_data != "up":
                                                    wb['F-{}'.format(test_case)].cell(index1,33).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                            if key == "fail_reason":
                                                info_data = F"{val}"
                                                wb['F-{}'.format(test_case)].cell(index1,34).value = info_data
                                            elif key == "result":
                                                info_data = F"{val}"
                                                wb['F-{}'.format(test_case)].cell(index1,35).value = info_data
                            # --- placed in center ---
                            alignment = Alignment(horizontal='center', vertical='center')
                            for row in wb['F-{}'.format(test_case)].iter_rows(min_row=1, max_row=wb['F-{}'.format(test_case)].max_row, min_col=1, max_col=wb['F-{}'.format(test_case)].max_column):
                                for cell in row:
                            ...
                            for count, fail_item in enumerate(pw_result['Working PW error status'],start=1):
                                for ind, (key,val) in enumerate(fail_item.items()):
                                    if ind == 0:
                                        ...
                                        ctrl_num = re.search(r'CTRL-(\d+)', info_data)
                                        if dut_num:
                                            sheet.cell(index+count-1,6).value = int(dut_num.group(1))
                                        if ctrl_num:
                                            sheet.cell(index+count-1,7).value = int(ctrl_num.group(1))
                                        sheet.cell(index+count-1,8).value = (info_data.split())[-1]
                                    elif ind == 1:
                                        info_data = F"{val}"
                                        sheet.cell(index+count-1,9).value = float(info_data)
                                        ...
                                        info_data = F"{val}"
                                        sheet.cell(index+count-1,11).value = info_data
                                        info_data1 = re.search(r'(\d+\.\d+)', info_data)
                                        if info_data1:
                                            result = float(info_data1.group(1))
                                            if result > 12.0 or result < 4.0:
                                        ...
                                        sheet.cell(index+count-1,18).value = float(info_data)
                                        if float(info_data) > 0.0:
                                            sheet.cell(index+count-1,18).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 11:
                                        info_data = F"{val}"
                                        sheet.cell(index+count-1,19).value = info_data
                                        if info_data != "up":
                                            sheet.cell(index+count-1,19).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    if key == "fail_reason":
                                        info_data = F"{val}"
                            ...
                            for count, fail_item in enumerate(pw_result['Standby PW error status'],start=1):
                                for ind, (key,val) in enumerate(fail_item.items()):
                                    if ind == 0:
                                        ...
                                        ctrl_num = re.search(r'CTRL-(\d+)', info_data)
                                        if dut_num:
                                            sheet.cell(index+count-1,22).value = float(dut_num.group(1))
                                        if ctrl_num:
                                            sheet.cell(index+count-1,23).value = float(ctrl_num.group(1))
                                        sheet.cell(index+count-1,24).value = (info_data.split())[-1]
                                    elif ind == 1:
                                        info_data = F"{val}"
                                        sheet.cell(index+count-1,25).value = float(info_data)
                                        if float(info_data) != 0.0:
                                            sheet.cell(index+count-1,25).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 2:
                                        info_data = F"{val}"
                                        sheet.cell(index+count-1,26).value = float(info_data)
                                        if float(info_data) != 0.0:
                                            sheet.cell(index+count-1,26).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 3:
                                        info_data = F"{val}"
                                        sheet.cell(index+count-1,27).value = info_data
                                        info_data1 = re.search(r'(\d+\.\d+)', info_data)
                                        if info_data1:
                                            result = float(info_data1.group(1))
                                            if result > 12.0 or result < 4.0:
                                        ...
                                        info_data = F"{val}"
                                        sheet.cell(index+count-1,35).value = info_data
                                        if info_data != "up":
                                            sheet.cell(index+count-1,35).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    if key == "fail_reason":
                                        info_data = F"{val}"
                                        sheet.cell(index+count-1,36).value = info_data
                                        if info_data != '':
                                            sheet.cell(index+count-1,36).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif key == "result":
                                        info_data = F"{val}"
                        ...
                        for i in range(30,38):
                            sheet.merge_cells(start_row=2,end_row=3,start_column=i,end_column=i)
                        sheet.merge_cells(start_row=2,end_row=2,start_column=9,end_column=13)
                        sheet.merge_cells(start_row=2,end_row=2,start_column=25,end_column=29)
            # --- placed in center ---
            alignment = Alignment(horizontal='center', vertical='center')
            for row in sheet.iter_rows(min_row=1, max_row=sheet.max_row, min_col=1, max_col=sheet.max_column):
                for cell in row:
            ...
            for vlan_mode,vlan_mode_item in test_result[test_case].items():
                for bundle_ids, rs485_item in vlan_mode_item.items():
                    for action,rs485_result in rs485_item.items():
                        index = sheet.max_row + 1
                        sheet.cell(index,1).value = vlan_mode
                        sheet.cell(index,2).value = bundle_ids
                        sheet.cell(index,3).value = action
                        sheet.cell(index,4).value = rs485_result['pass']
                        sheet.cell(index,5).value = rs485_result['fail']
                        if rs485_result['fail'] > 0:
                            ...
                            if f'F-{test_case}' not in wb.sheetnames and test_case in ['Bundle test(RS485 status)']:
                                ...
                                set_title_for_sheet('Bundle IDs',wb['F-{}'.format(test_case)],1,2,2,"5cb800")
                                set_title_for_sheet('Check time',wb['F-{}'.format(test_case)],1,3,3,"5cb800")
                                set_title_for_sheet('RS485 error info by slot',wb['F-{}'.format(test_case)],1,4,4,"5cb800")
                                wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=1,start_column=4,end_column=4+len(slot_second_name)-1)
                                set_title_for_sheet('RS485 error info',wb['F-{}'.format(test_case)],1,17,17,"5cb800")
                                wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=1,start_column=17,end_column=17+len(sta_second_name)-1)
                                # --- second row ---
                                for i in range(0,len(slot_second_name)):
                                    set_title_for_sheet(slot_second_name[i],wb['F-{}'.format(test_case)],max_row+1,4+i,4+i,"5cb800")
                                for i in range(0,len(sta_second_name)):
                                    set_title_for_sheet(sta_second_name[i],wb['F-{}'.format(test_case)],max_row+1,17+i,17+i,"5cb800")
                                # --- merge ---
                                for i in range(1,4):
                                    wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=2,start_column=i,end_column=i)
                            fail_count = 0
                                    ...
                                    for ind, (key,val) in enumerate(fail_item.items()):
                                        if len(fail_item) > 6:
                                            ...
                                            if ind == 0:
                                                ...
                                                dut_num = re.search(r'DUT (\d+)', info_data)
                                                if dut_num:
                                                    wb['F-{}'.format(test_case)].cell(index1+minus_count,17).value = int(dut_num.group(1))
                                            elif ind == 1:
                                                info_data = F"{val}"
                                                wb['F-{}'.format(test_case)].cell(index1+minus_count,18).value = float(info_data)
                                            elif ind == 2:
                                                info_data = F"{val}"
                                                ...
                                                if float(info_data) != 0.0:
                                                    wb['F-{}'.format(test_case)].cell(index1+minus_count,20).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                            elif ind == 4:
                                                info_data = F"{val}"
                                                wb['F-{}'.format(test_case)].cell(index1+minus_count,21).value = info_data
                                                if info_data == 'fail':
                                ...
                                for ind, (key,val) in enumerate(fail_item.items()):
                                    if len(fail_item) > 6:
                                        ...
                                        if ind == 0:
                                            ...
                                            dut_num = re.search(r'DUT (\d+)', info_data)
                                            if dut_num:
                                                sheet.cell(index+minus_count,19).value = int(dut_num.group(1))
                                        elif ind == 1:
                                            info_data = F"{val}"
                                            sheet.cell(index+minus_count,20).value = float(info_data)
                                        elif ind == 2:
                                            info_data = F"{val}"
                                            ...
                                            if float(info_data) != 0:
                                                sheet.cell(index+minus_count,22).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                        elif ind == 4:
                                            info_data = F"{val}"
                                            sheet.cell(index+minus_count,23).value = info_data
                                            if info_data == 'fail':
            ...
            set_title_for_sheet('Bert type',sheet,1,2,1,"daeef3")
            set_title_for_sheet('Pass',sheet,1,3,1,"daeef3")
            set_title_for_sheet('Fail',sheet,1,4,1,"daeef3")
            for i in range(1,5):
                sheet.merge_cells(start_row=1,end_row=2,start_column=i,end_column=i)
            set_title_for_sheet('Ctrl Fail item',sheet,1,5,1,"daeef3")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=5,end_column=8)
            set_title_for_sheet('Time',sheet,2,5,1,"daeef3")
            set_title_for_sheet('Bit Error',sheet,2,6,1,"daeef3")
            set_title_for_sheet('Error ID',sheet,2,7,1,"daeef3")
            set_title_for_sheet('Elapsed Time',sheet,2,8,1,"daeef3")

            set_title_for_sheet('Test Card Fail item',sheet,1,9,1,"daeef3")
            set_title_for_sheet('Time',sheet,2,9,1,"daeef3")
            set_title_for_sheet('PRBS Status',sheet,2,10,1,"daeef3")
            set_title_for_sheet('Error Counts',sheet,2,11,1,"daeef3")
            set_title_for_sheet('Error ID',sheet,2,12,1,"daeef3")
            set_title_for_sheet('Error Seconds',sheet,2,13,1,"daeef3")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=9,end_column=13)
            
            max_row = 1
            for round, round_result in test_result[test_case].items():
                for bert_type, bert_item in round_result.items():
                    index = sheet.max_row + 1
                    sheet.cell(index, 1).number_format = '0'
                    merge_row_title_for_sheet(int(round),sheet,index,1,index+bert_item['fail']-1,"FFFFFF")
                    merge_row_title_for_sheet(bert_type,sheet,index,2,index+bert_item['fail']-1,"FFFFFF")
                    merge_row_title_for_sheet(bert_item['pass'],sheet,index,3,index+bert_item['fail']-1,"FFFFFF")
                    merge_row_title_for_sheet(bert_item['fail'],sheet,index,4,index+bert_item['fail']-1,"FFFFFF")
                    append_data = ''
                    if bert_item['fail'] > 0:
                        ...
                        for count, fail_item in enumerate(bert_item['fail_item'],start=1):
                            ...
                            for i in range(1,4):
                                wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=2,start_column=i,end_column=i)
                            set_title_for_sheet('Ctrl Fail item',wb['F-{}'.format(test_case)],1,4,1,"daeef3")
                            ...
                            set_title_for_sheet('Test Card Fail item',wb['F-{}'.format(test_case)],1,8,1,"daeef3")
                            set_title_for_sheet('Time',wb['F-{}'.format(test_case)],2,8,1,"daeef3")
                            set_title_for_sheet('PRBS Status',wb['F-{}'.format(test_case)],2,9,1,"daeef3")
                            set_title_for_sheet('Error Counts',wb['F-{}'.format(test_case)],2,10,1,"daeef3")
                            set_title_for_sheet('Error ID',wb['F-{}'.format(test_case)],2,11,1,"daeef3")
                            set_title_for_sheet('Error Seconds',wb['F-{}'.format(test_case)],2,12,1,"daeef3")
                            wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=1,start_column=8,end_column=12)
                            ...
                            for row_index2 in range(1,1+len(append_data.splitlines())):
                                ...
                                if match1:
                                    wb['F-{}'.format(test_case)].cell(index2,4).value = match1.group(1)
                                    wb['F-{}'.format(test_case)].cell(index2,5).value = int(match1.group(2))
                                    wb['F-{}'.format(test_case)].cell(index2,6).value = int(match1.group(3))
                                    wb['F-{}'.format(test_case)].cell(index2,7).value = int(match1.group(4))
                                ...
                                if match2:
                                    wb['F-{}'.format(test_case)].cell(index2,8).value = match2.group(1)
                                    wb['F-{}'.format(test_case)].cell(index2,9).value = match2.group(2)
                                    wb['F-{}'.format(test_case)].cell(index2,10).value = int(match2.group(3))
                                    wb['F-{}'.format(test_case)].cell(index2,11).value = int(match2.group(4))
                                    wb['F-{}'.format(test_case)].cell(index2,12).value = int(match2.group(5))
                        # --- placed in center ---
                        alignment = Alignment(horizontal='center', vertical='center')
                        for row in wb['F-{}'.format(test_case)].iter_rows(min_row=1, max_row=wb['F-{}'.format(test_case)].max_row, min_col=1, max_col=wb['F-{}'.format(test_case)].max_column):
                            for cell in row:
                    ...
                    if len(bert_item['fail_item']) > 0:
                        sheet.cell(index,5).alignment = Alignment(wrap_text=True)
                        for count, fail_item in enumerate(bert_item['fail_item'],start=1):
                            if len(fail_item) < 5:
                                for key,val in fail_item.items():
                                    if key == "Time":
                                        sheet.cell(index+count-1,5).value = val
                                    if key == "Bit Error":
                                        sheet.cell(index+count-1,6).value = int(val)
                                    if key == "Error ID":
                                        sheet.cell(index+count-1,7).value = int(val)
                                    if key == "Elapsed Time":
                                        sheet.cell(index+count-1,8).value = int(val)
                                ...
                                for key,val in fail_item.items():
                                    if key == "Time":
                                        sheet.cell(index+count-1,9).value = val
                                    if key == "PRBSStatus":
                                        sheet.cell(index+count-1,10).value = val
                                    if key == "ErrorCounts":
                                        sheet.cell(index+count-1,11).value = int(val)
                                    if key == "Error ID":
                                        sheet.cell(index+count-1,12).value = int(val)
                                    if key == "ErrorSeconds":
                                        sheet.cell(index+count-1,13).value = int(val)
            ...
            second_name = ['DUT','CTRL', 'Bundle','Primary/Secondary', "Jitter buffer", "L bit count", "R bit count", 
                           "TX Good count","RX Good count","RX lost count", "Link", "Fail reason","Result"]
            jitter_name = ['Under run','Over run','Depth','MIN','MAX']
            set_title_for_sheet('Round',sheet,max_row,1,1,"daeef3")
            #set_title_for_sheet('DUT',sheet,max_row,2,2,"daeef3")
            #set_title_for_sheet('CTRL',sheet,max_row,3,3,"daeef3")
            #set_title_for_sheet('Bundle',sheet,max_row,4,4,"daeef3")
            #set_title_for_sheet('Primary/Secondary',sheet,max_row,5,5,"daeef3")
            set_title_for_sheet('Pass',sheet,max_row,2,2,"daeef3")
            set_title_for_sheet('Fail',sheet,max_row,3,3,"daeef3")
            set_title_for_sheet('Working PW',sheet,max_row,4,4,"daeef3")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=4,end_column=4+len(second_name)+len(jitter_name)-2)
            set_title_for_sheet('Standby PW',sheet,max_row,21,21,"daeef3")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=21,end_column=21+len(second_name)+len(jitter_name)-2)
            
            color_array = ["ffffff","d9d9d9"]
            # --- second row ---
            for i in range(0,5):
                set_title_for_sheet(second_name[i],sheet,max_row+1,4+i,4+i,"daeef3")
            for i in range(5,len(second_name)):
                set_title_for_sheet(second_name[i],sheet,max_row+1,4+len(jitter_name)+i-1,4+len(jitter_name)+i-1,"daeef3")
            for i in range(0,5):
                set_title_for_sheet(second_name[i],sheet,max_row+1,21+i,21+i,"daeef3")
            for i in range(5,len(second_name)):
                set_title_for_sheet(second_name[i],sheet,max_row+1,21+len(jitter_name)+i-1,21+len(jitter_name)+i-1,"daeef3")
            # --- third row ---
            for i in range(len(jitter_name)):
                set_title_for_sheet(jitter_name[i],sheet,max_row+2,8+i,8+i,"daeef3")
            for i in range(len(jitter_name)):
                set_title_for_sheet(jitter_name[i],sheet,max_row+2,25+i,25+i,"daeef3")
      
            for round, round_result in test_result[test_case].items():
                index = sheet.max_row + 1
                sheet.cell(index, 1).number_format = '0'
                sheet.cell(index, 1).value = int(round)
                sheet.cell(index, 2).value = round_result['pass']
                sheet.cell(index, 3).value = round_result['fail']
                if len(round_result['Working PW error status']) > 0:
                    for count, fail_item in enumerate(round_result['Working PW error status'],start=1):
                        for ind, (key,val) in enumerate(fail_item.items()):
                            if ind == 0:
                                info_data = F"{val}"
                                dut_num = re.search(r'DUT (\d+)', info_data)
                                ...
                                bundle_num = re.search(r'Bundle (\d+)', info_data)
                                if dut_num:
                                    sheet.cell(index+count-1,4).value = float(dut_num.group(1))
                                if ctrl_num:
                                    sheet.cell(index+count-1,5).value = float(ctrl_num.group(1))
                                if bundle_num:
                                    sheet.cell(index+count-1,6).value = float(bundle_num.group(1))
                                sheet.cell(index+count-1,7).value = (info_data.split())[-1]
                            elif ind == 1:
                                info_data = F"{val}"
                                sheet.cell(index+count-1,8).value = float(info_data)
                                if float(info_data) != 0.0:
                                    sheet.cell(index+count-1,8).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                            elif ind == 2:
                                info_data = F"{val}"
                                sheet.cell(index+count-1,9).value = float(info_data)
                                if float(info_data) != 0.0:
                                ...
                                info_data = F"{val}"
                                sheet.cell(index+count-1,18).value = info_data
                                if info_data != "up":
                                    sheet.cell(index+count-1,18).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                            if key == "fail_reason":
                                info_data = F"{val}"
                                ...
                                if info_data == 'fail':
                                    sheet.cell(index+count-1,20).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                if len(round_result['Standby PW error status']) > 0:
                    for count, fail_item in enumerate(round_result['Standby PW error status'],start=1):
                        for ind, (key,val) in enumerate(fail_item.items()):
                            if ind == 0:
                                info_data = F"{val}"
                                dut_num = re.search(r'DUT (\d+)', info_data)
                                ...
                                bundle_num = re.search(r'Bundle (\d+)', info_data)
                                if dut_num:
                                    sheet.cell(index+count-1,21).value = float(dut_num.group(1))
                                if ctrl_num:
                                    sheet.cell(index+count-1,22).value = float(ctrl_num.group(1))
                                if bundle_num:
                                    sheet.cell(index+count-1,23).value = float(bundle_num.group(1))
                                sheet.cell(index+count-1,24).value = (info_data.split())[-1]
                            elif ind == 1:
                                info_data = F"{val}"
                                sheet.cell(index+count-1,25).value = float(info_data)
                            ...
                            if key == "fail_reason":
                                ...
                                if info_data == 'fail':
                                    sheet.cell(index+count-1,37).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                if round_result['fail'] > 0:
                    sheet.cell(index, 3).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                    # --- create fail sheet ---
                    if f'F-{test_case}' not in wb.sheetnames and test_case in ['Long Time(PW status)']:
                        ...
                        set_title_for_sheet('Working PW error info',wb['F-{}'.format(test_case)],1,2,2,"daeef3")
                        wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=1,start_column=2,end_column=2+len(second_name)+len(jitter_name)-2)
                        set_title_for_sheet('Standby PW error info',wb['F-{}'.format(test_case)],1,19,19,"daeef3")
                        wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=1,start_column=19,end_column=19+len(second_name)+len(jitter_name)-2)
                        # --- second row ---
                        for i in range(0,5):
                            set_title_for_sheet(second_name[i],wb['F-{}'.format(test_case)],max_row+1,2+i,2+i,"daeef3")
                        for i in range(5,len(second_name)):
                            set_title_for_sheet(second_name[i],wb['F-{}'.format(test_case)],max_row+1,2+len(jitter_name)+i-1,2+len(jitter_name)+i-1,"daeef3")
                        for i in range(0,5):
                            set_title_for_sheet(second_name[i],wb['F-{}'.format(test_case)],max_row+1,19+i,19+i,"daeef3")
                        for i in range(5,len(second_name)):
                            set_title_for_sheet(second_name[i],wb['F-{}'.format(test_case)],max_row+1,19+len(jitter_name)+i-1,19+len(jitter_name)+i-1,"daeef3")
                        # --- third row ---
                        for i in range(len(jitter_name)):
                            set_title_for_sheet(jitter_name[i],wb['F-{}'.format(test_case)],max_row+2,6+i,6+i,"daeef3")
                        for i in range(len(jitter_name)):
                            set_title_for_sheet(jitter_name[i],wb['F-{}'.format(test_case)],max_row+2,23+i,23+i,"daeef3")
                        # --- merge ---
                        ...
                        for i in range(28,36):
                            wb['F-{}'.format(test_case)].merge_cells(start_row=2,end_row=3,start_column=i,end_column=i)
                        wb['F-{}'.format(test_case)].merge_cells(start_row=2,end_row=2,start_column=6,end_column=10)
                        wb['F-{}'.format(test_case)].merge_cells(start_row=2,end_row=2,start_column=23,end_column=27)
                    fail_count = 0
                    for count, fail_item in enumerate(round_result['Working PW error status'],start=1):
                        if round_result['Working PW error status'][count-1]['result'] == 'fail':
                            fail_count += 1
                            index1 = wb['F-{}'.format(test_case)].max_row + 1
                            for ind, (key,val) in enumerate(fail_item.items()):
                                ...
                                if ind == 0:
                                    ...
                                    bundle_num = re.search(r'Bundle (\d+)', info_data)
                                    if dut_num:
                                        wb['F-{}'.format(test_case)].cell(index1,2).value = float(dut_num.group(1))
                                    if ctrl_num:
                                        wb['F-{}'.format(test_case)].cell(index1,3).value = float(ctrl_num.group(1))
                                    if bundle_num:
                                        wb['F-{}'.format(test_case)].cell(index1,4).value = float(bundle_num.group(1))
                                    wb['F-{}'.format(test_case)].cell(index1,5).value = (info_data.split())[-1]
                                elif ind == 1:
                                    info_data = F"{val}"
                                    wb['F-{}'.format(test_case)].cell(index1,6).value = float(info_data)
                                    if float(info_data) != 0.0:
                                        wb['F-{}'.format(test_case)].cell(index1,6).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                elif ind == 2:
                                    info_data = F"{val}"
                                    wb['F-{}'.format(test_case)].cell(index1,7).value = float(info_data)
                                    if float(info_data) != 0.0:
                                    ...
                                    info_data = F"{val}"
                                    wb['F-{}'.format(test_case)].cell(index1,8).value = info_data
                                    info_data1 = re.search(r'(\d+\.\d+)', info_data)
                                    if info_data1:
                                        result = float(info_data1.group(1))
                                        if result > 12.0 or result < 4.0:
                                    ...
                                    info_data = F"{val}"
                                    wb['F-{}'.format(test_case)].cell(index1,16).value = info_data
                                    if info_data != "up":
                                        wb['F-{}'.format(test_case)].cell(index1,16).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                if key == "fail_reason":
                                    info_data = F"{val}"
                                    ...
                                    info_data = F"{val}"
                                    wb['F-{}'.format(test_case)].cell(index1,18).value = info_data
                            if round_result['Standby PW error status'][count-1]['result'] == 'fail':
                                fail_item = round_result['Standby PW error status'][count-1]
                                for ind, (key,val) in enumerate(fail_item.items()):
                                    if ind == 0:
                                        info_data = F"{val}"
                                        dut_num = re.search(r'DUT (\d+)', info_data)
                                        ...
                                        bundle_num = re.search(r'Bundle (\d+)', info_data)
                                        if dut_num:
                                            wb['F-{}'.format(test_case)].cell(index1,19).value = float(dut_num.group(1))
                                        if ctrl_num:
                                            wb['F-{}'.format(test_case)].cell(index1,20).value = float(ctrl_num.group(1))
                                        if bundle_num:
                                            wb['F-{}'.format(test_case)].cell(index1,21).value = float(bundle_num.group(1))
                                        wb['F-{}'.format(test_case)].cell(index1,22).value = (info_data.split())[-1]
                                    elif ind == 1:
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index1,23).value = float(info_data)
                    ...
                    for row in wb['F-{}'.format(test_case)].iter_rows(min_row=1, max_row=wb['F-{}'.format(test_case)].max_row, min_col=1, max_col=wb['F-{}'.format(test_case)].max_column):
                        for cell in row:
                            cell.alignment = alignment
                    wb['F-{}'.format(test_case)].freeze_panes = 'B4'
                # --- merge ---
                for i in range(1,4):
                    sheet.merge_cells(start_row=1,end_row=3,start_column=i,end_column=i)
                    sheet.merge_cells(start_row=index,end_row=index+count-1,start_column=i,end_column=i)
                ...
                for i in range(30,38):
                    sheet.merge_cells(start_row=2,end_row=3,start_column=i,end_column=i)
                sheet.merge_cells(start_row=2,end_row=2,start_column=8,end_column=12)
                sheet.merge_cells(start_row=2,end_row=2,start_column=25,end_column=29)
                # --- placed in center ---
                alignment = Alignment(horizontal='center', vertical='center')
                for row in sheet.iter_rows(min_row=1, max_row=sheet.max_row, min_col=1, max_col=sheet.max_column):
            ...
            set_title_for_sheet('Pass',sheet,max_row,2,1,"daeef3")
            set_title_for_sheet('Fail',sheet,max_row,3,1,"daeef3")
            set_title_for_sheet('RS485 info by slot',sheet,max_row,4,1,"daeef3")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=4,end_column=4+len(slot_second_name)-1)
            set_title_for_sheet('RS485 info',sheet,max_row,17,1,"daeef3")
            sheet.merge_cells(start_row=max_row,end_row=max_row,start_column=17,end_column=17+len(sta_second_name)-1)
            for i in range(0,len(slot_second_name)):
                set_title_for_sheet(slot_second_name[i],sheet,max_row+1,4+i,4+i,"daeef3")
            for i in range(0,len(sta_second_name)):
                set_title_for_sheet(sta_second_name[i],sheet,max_row+1,17+i,17+i,"daeef3")
            for round, round_result in test_result[test_case].items():
                index = sheet.max_row + 1
                sheet.cell(index, 1).number_format = '0'
                sheet.cell(index, 1).value = int(round)
                ...
                # --- create fail sheet ---
                    if f'F-{test_case}' not in wb.sheetnames and test_case in ['Long Time(RS485 status)']:
                        wb.create_sheet('F-{}'.format(test_case),index=100)
                        set_title_for_sheet('Round',wb['F-{}'.format(test_case)],1,1,1,"daeef3")
                        set_title_for_sheet('RS485 error info by slot',wb['F-{}'.format(test_case)],1,2,2,"daeef3")
                        wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=1,start_column=2,end_column=2+len(slot_second_name)-1)
                        set_title_for_sheet('RS485 error info',wb['F-{}'.format(test_case)],1,15,15,"daeef3")
                        wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=1,start_column=15,end_column=15+len(sta_second_name)-1)
                        # --- second row ---
                        for i in range(0,len(slot_second_name)):
                            set_title_for_sheet(slot_second_name[i],wb['F-{}'.format(test_case)],max_row+1,2+i,2+i,"daeef3")
                        for i in range(0,len(sta_second_name)):
                            set_title_for_sheet(sta_second_name[i],wb['F-{}'.format(test_case)],max_row+1,15+i,15+i,"daeef3")
                        # --- merge ---
                        for i in range(1,2):
                            wb['F-{}'.format(test_case)].merge_cells(start_row=1,end_row=2,start_column=i,end_column=i)
                    fail_count = 0
                    for count, fail_item in enumerate(round_result['RS485 error status'],start=1):
                        minus_count = 0
                        if round_result['RS485 error status'][count-1]['result'] == 'fail':
                            fail_count += 1
                            index1 = wb['F-{}'.format(test_case)].max_row + 1
                            for ind, (key,val) in enumerate(fail_item.items()):
                                if len(fail_item) > 6:
                                    if ind == 0:
                                        ...
                                        slot_abc = re.search(r'slot ([a-zA-Z])', info_data)
                                        if dut_num:
                                            wb['F-{}'.format(test_case)].cell(index1-minus_count,2).value = int(dut_num.group(1))
                                        if slot_num:
                                            wb['F-{}'.format(test_case)].cell(index1-minus_count,3).value = int(slot_num.group(1))
                                        if slot_abc:
                                            wb['F-{}'.format(test_case)].cell(index1-minus_count,3).value = slot_abc.group(1)
                                    elif ind == 1:
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index1-minus_count,4).value = float(info_data)
                                    elif ind == 2:
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index1-minus_count,5).value = float(info_data) 
                                    elif ind == 3:
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index1-minus_count,6).value = float(info_data)
                                        if float(info_data) != 0.0:
                                            wb['F-{}'.format(test_case)].cell(index1-minus_count,6).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 4:
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index1-minus_count,7).value = float(info_data)
                                        if float(info_data) != 0.0:
                                            wb['F-{}'.format(test_case)].cell(index1-minus_count,7).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                    elif ind == 5:
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index1-minus_count,8).value = float(info_data)
                                    elif ind == 6:
                                        ...
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index1-minus_count,14).value = info_data
                                        if info_data == 'fail':
                                            wb['F-{}'.format(test_case)].cell(index1-minus_count,14).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                else:
                                    if ind == 0:
                                        ...
                                        dut_num = re.search(r'DUT (\d+)', info_data)
                                        if dut_num:
                                            wb['F-{}'.format(test_case)].cell(index1+minus_count,15).value = int(dut_num.group(1))
                                    elif ind == 1:
                                        info_data = F"{val}"
                                        ...
                                        info_data = F"{val}"
                                        wb['F-{}'.format(test_case)].cell(index1+minus_count,19).value = info_data
                                        if info_data == 'fail':
                                            wb['F-{}'.format(test_case)].cell(index1+minus_count,19).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                            if len(fail_item) <= 6:
                                minus_count += 1
                    ...
                    for row in wb['F-{}'.format(test_case)].iter_rows(min_row=1, max_row=wb['F-{}'.format(test_case)].max_row, min_col=1, max_col=wb['F-{}'.format(test_case)].max_column):
                        for cell in row:
                            cell.alignment = alignment
                    wb['F-{}'.format(test_case)].freeze_panes = 'B3'

                if len(round_result['RS485 error status']) > 0:
                    info_data = ''
                    minus_count = 0
                    for count, fail_item in enumerate(round_result['RS485 error status'],start=1):
                        for ind, (key,val) in enumerate(fail_item.items()):
                            if len(fail_item) > 6:
                                if ind == 0:
                                    ...
                                    slot_abc = re.search(r'slot ([a-zA-Z])', info_data)
                                    if dut_num:
                                        sheet.cell(index+count-minus_count-1,4).value = int(dut_num.group(1))
                                    if slot_num:
                                        sheet.cell(index+count-minus_count-1,5).value = int(slot_num.group(1))
                                    if slot_abc:
                                        sheet.cell(index+count-minus_count-1,5).value = slot_abc.group(1)
                                elif ind == 1:
                                    info_data = F"{val}"
                                    sheet.cell(index+count-minus_count-1,6).value = float(info_data)
                                elif ind == 2:
                                    info_data = F"{val}"
                                    sheet.cell(index+count-minus_count-1,7).value = float(info_data) 
                                elif ind == 3:
                                    info_data = F"{val}"
                                    sheet.cell(index+count-minus_count-1,8).value = float(info_data)
                                    if float(info_data) != 0.0:
                                        sheet.cell(index+count-minus_count-1,8).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                elif ind == 4:
                                    info_data = F"{val}"
                                    sheet.cell(index+count-minus_count-1,9).value = float(info_data)
                                    if float(info_data) != 0.0:
                                        sheet.cell(index+count-minus_count-1,9).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                elif ind == 5:
                                    info_data = F"{val}"
                                    sheet.cell(index+count-minus_count-1,10).value = float(info_data)
                                elif ind == 6:
                                    ...
                                    info_data = F"{val}"
                                    sheet.cell(index+count-minus_count-1,16).value = info_data
                                    if info_data == 'fail':
                                        sheet.cell(index+count-minus_count-1,16).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                            else:
                                if ind == 0:
                                    ...
                                    dut_num = re.search(r'DUT (\d+)', info_data)
                                    if dut_num:
                                        sheet.cell(index+minus_count,17).value = int(dut_num.group(1))
                                elif ind == 1:
                                    info_data = F"{val}"
                                    sheet.cell(index+minus_count,18).value = float(info_data)
                                elif ind == 2:
                                    info_data = F"{val}"
                                    sheet.cell(index+minus_count,19).value = float(info_data) 
                                elif ind == 3:
                                    info_data = F"{val}"
                                    sheet.cell(index+minus_count,20).value = float(info_data)
                                    if float(info_data) != 0.0:
                                        sheet.cell(index+minus_count,20).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                                elif ind == 4:
                                    info_data = F"{val}"
                                    sheet.cell(index+minus_count,21).value = info_data
                                    if info_data == 'fail':
                                        sheet.cell(index+minus_count,21).fill = PatternFill(start_color="e53b31", fill_type = "solid")
                        if len(fail_item) <= 6:
                            minus_count += 1
                # --- merge ---
                for i in range(1,4):
        ...
        '''
            ...
            for x, item1 in enumerate(voice_title):
                sheet.cell(max_row,x+1).value = item1
                sheet.cell(max_row,x+1).font = Font(bold=True)
                sheet.cell(max_row,x+1).fill = PatternFill("solid", start_color="5cb800")
                sheet.cell(max_row,x+1).alignment = Alignment(horizontal='center', vertical='center') 
            ...
            for row_index, item in enumerate(list(sorted(test_result[test_case]["Items"].keys())),start=2):
                for row_index2, item2 in enumerate(list(sorted(test_result[test_case]["Items"][item].keys())),start=2):
                    ...
                    if pass_cnt + fail_cnt > 0:
                        ...
                        sheet.cell(row_index,2).value = card_info_array[1]
                        sheet.cell(row_index,3).value = card_info_array[2]
                        sheet.cell(row_index,4).value = au_ohm[0]
                        sheet.cell(row_index,5).value = au_ohm[1]

                        sheet.cell(row_index,6).number_format = '0'
                        sheet.cell(row_index,7).number_format = '0'
                        sheet.cell(row_index,8).number_format = '0'
                        sheet.cell(row_index,6).value = pass_cnt
                        sheet.cell(row_index,7).value = fail_cnt

                        for a in range(1,9):
                            sheet.cell(row_index,a).alignment = Alignment(horizontal='center', vertical='center')                   

                        if pass_cnt != 0:
                            sheet.cell(row_index,8).value = "{0:.1%}".format(pass_cnt / (pass_cnt+fail_cnt))
                        else:
                            sheet.cell(row_index,8).value = 0
                        ...
                        if len(fail_items) > 0:
                            ...
                            append_data = append_data.rstrip()
                            append_data = append_data.strip()                                
                            sheet.cell(row_index,9).alignment = Alignment(wrap_text=True)
                            sheet.cell(row_index,9).value = append_data
                            create_voice_fail_info_sheet(wb,test_case,card_info_array[0],card_info_array[1],
                                                        card_info_array[2], au_ohm[0], au_ohm[1],append_data)
        # ------ voice test -------- 
         '''   
        print("Done!")
