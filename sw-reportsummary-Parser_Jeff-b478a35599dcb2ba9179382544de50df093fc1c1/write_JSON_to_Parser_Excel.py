...
file_path = "C:/Users/jeff-hsu/Desktop/Newest JSON/sw-autoit-2020/Test_Case/case_344CCPA/5_GE_ccpb_2ge/test_results/0219"
...
bert_case = ["Warm Reset",
        ...
        'Download cfg']
test_case = ''
excel_path = Path(F'C:/Users/jeff-hsu/Desktop/test_result_ini/20240103/summary_json_parser_{date}.xlsx')
detail_items = {}
test_summary = {}
cur_pass = {}
cur_fail = {}
...
for x,action_item in enumerate(test_result):
    ...
    for x1,timecase_item in enumerate(test_result[action_item]):
        ...
        # if ini_test_case == 'PwBundleStaticsEntry' or ini_test_case == 'PwStandbyStaticsEntry':
        #     # detail_start_col = 8
        #     cur_test_case = case_translation_table.get(ini_test_case)
        #     if ini_test_case == 'PwStandbyStaticsEntry':
        #         sec_test_case_count[cur_test_case] += 1
        #     else:
        #         test_case_count[cur_test_case] += 1
        #         row_index[cur_test_case] = sheet.max_row + 1
        #     if test_case_count[cur_test_case] == 1:
        #         first_row_index[cur_test_case] = row_index[cur_test_case] - 1
        #     data, fail_item = PW_Status_parse(test_result[action_item][timecase_item],ini_test_case)
        #     detail_items[test_case] = data
        #     for num1,infor in enumerate(detail_items[test_case]):
        #         for num,(key, val) in enumerate(detail_items[test_case][infor].items()):
        #             if infor == 'Working PW Status':
        #                 sheet.cell(row_index[cur_test_case],detail_start_col).value = time_item
        #                 if test_case_length['PwBundleStaticsEntry'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col,detail_start_col,"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col,end_column=detail_start_col+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col,detail_start_col,"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+num+1,detail_start_col+num+1,"5cb800")
        #                 test_case_length['PwBundleStaticsEntry'] = len(detail_items[test_case][infor])+1
        #                 sheet.cell(row_index[cur_test_case], detail_start_col+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        ...
        #                             else:
        #                                 pass                         
        #             elif infor == 'Standby PW Status':
        #                 sec_info_row = first_row_index[cur_test_case] + sec_test_case_count[cur_test_case]
        #                 sheet.cell(sec_info_row,detail_start_col+test_case_length['PwBundleStaticsEntry']).value = time_item
        #                 if test_case_length['PwStandbyStaticsEntry'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col+test_case_length['PwBundleStaticsEntry'],detail_start_col+test_case_length['Rs485SlotStatistEntry'],"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col+test_case_length['PwBundleStaticsEntry'],
        #                                       end_column=detail_start_col+test_case_length['PwBundleStaticsEntry']+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col+test_case_length['PwBundleStaticsEntry'],detail_start_col+test_case_length['PwBundleStaticsEntry'],"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+test_case_length['PwBundleStaticsEntry']+num+1,detail_start_col+test_case_length['Rs485SlotStatistEntry']+num+1,"5cb800")
        #                 test_case_length['PwStandbyStaticsEntry'] = len(detail_items[test_case][infor])
        #                 sheet.cell(sec_info_row, detail_start_col+test_case_length['PwBundleStaticsEntry']+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        #                             if key == fail_item_name:
        #                                 sheet.cell(sec_info_row, detail_start_col+test_case_length['PwBundleStaticsEntry']+num+1).fill = PatternFill(start_color="e53b31", fill_type = "solid")
        #                             else:
        #                                 pass
        # elif ini_test_case == 'Rs485SlotStatistEntry' or ini_test_case == 'Rs485StatistTable':
        #     detail_start_col = 7
        #     cur_test_case = 'RS485 Status'
        #     if ini_test_case == 'Rs485StatistTable':
        #         sec_test_case_count[cur_test_case] += 1
        #     else:
        #         test_case_count[cur_test_case] += 1
        #         row_index[cur_test_case] = sheet.max_row + 1
        #     if test_case_count[cur_test_case] == 1:
        #         first_row_index[cur_test_case] = row_index[cur_test_case] - 1
        #     data, fail_item = RS485_parse(test_result[action_item][timecase_item])
        #     detail_items[test_case] = data
        #     for num1,infor in enumerate(detail_items[test_case]):
        #         for num,(key, val) in enumerate(detail_items[test_case][infor].items()):
        #             if infor == 'RS485 info by slot':
        #                 sheet.cell(row_index[cur_test_case],detail_start_col).value = time_item
        #                 if test_case_length['Rs485SlotStatistEntry'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col,detail_start_col,"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col,end_column=detail_start_col+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col,detail_start_col,"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+num+1,detail_start_col+num+1,"5cb800")
        #                 test_case_length['Rs485SlotStatistEntry'] = len(detail_items[test_case][infor])+1
        #                 sheet.cell(row_index[cur_test_case], detail_start_col+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        ...
        #                             else:
        #                                 pass
        #             elif infor == 'RS485 info':
        #                 sec_info_row = first_row_index[cur_test_case] + sec_test_case_count[cur_test_case]
        #                 sheet.cell(sec_info_row,detail_start_col+test_case_length['Rs485SlotStatistEntry']).value = time_item
        #                 if test_case_length['Rs485StatistTable'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col+test_case_length['Rs485SlotStatistEntry'],detail_start_col+test_case_length['Rs485SlotStatistEntry'],"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col+test_case_length['Rs485SlotStatistEntry'],
        #                                       end_column=detail_start_col+test_case_length['Rs485SlotStatistEntry']+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col+test_case_length['Rs485SlotStatistEntry'],detail_start_col+test_case_length['Rs485SlotStatistEntry'],"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+test_case_length['Rs485SlotStatistEntry']+num+1,detail_start_col+test_case_length['Rs485SlotStatistEntry']+num+1,"5cb800")
        #                 test_case_length['Rs485StatistTable'] = len(detail_items[test_case][infor])
        #                 sheet.cell(sec_info_row, detail_start_col+test_case_length['Rs485SlotStatistEntry']+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        #                             if key == fail_item_name:
        #                                 sheet.cell(sec_info_row, detail_start_col+test_case_length['Rs485SlotStatistEntry']+num+1).fill = PatternFill(start_color="e53b31", fill_type = "solid")
        #                             else:
        #                                 pass                        
        # elif ini_test_case == 'PwPriProtectStatistEntry' or ini_test_case == 'PwSecProtectStatistEntry':
        #     detail_start_col = 7
        #     first_info = 'PwPriProtectStatistEntry'
        #     second_info = 'PwSecProtectStatistEntry'
        #     cur_test_case = case_translation_table.get(ini_test_case)
        #     if cur_test_case in case_mapping_table:
        #         mapping_case = case_mapping_table[cur_test_case]
        #     if ini_test_case == second_info:
        #         sec_test_case_count[cur_test_case] += 1
        #     else:
        #         test_case_count[cur_test_case] += 1
        #         row_index[cur_test_case] = sheet.max_row + 1
        ...
        #         first_row_index[cur_test_case] = row_index[cur_test_case] - 1
        #     function_name = cur_test_case.replace(' ', '_') + "_parse"
        #     data, fail_item = globals()[function_name](test_result[action_item][timecase_item],ini_test_case)
        #     detail_items[test_case] = data
        #     for num1,infor in enumerate(detail_items[test_case]):
        #         infor_key = {}
        #         infor_val = {}
        ...
        #             if infor == case_translation_table1.get(mapping_case['first_case']):
        #                 sheet.cell(row_index[cur_test_case],detail_start_col).value = time_item
        #                 if test_case_length[first_info] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col,detail_start_col,"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col,end_column=detail_start_col+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col,detail_start_col,"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+num+1,detail_start_col+num+1,"5cb800")
        #                 test_case_length[first_info] = len(detail_items[test_case][infor]) + 1
        #                 sheet.cell(row_index[cur_test_case], detail_start_col+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        ...
        #                                 pass
        #                 # == test
        #                 if key == 'Result' and (val == 'fail' or val == 'warning'):
        #                     if ('F-{}'.format(cur_test_case)) not in wb.sheetnames:
        #                         wb.create_sheet('F-{}'.format(cur_test_case))
        #                         fail_sheet_max_row = wb['F-{}'.format(cur_test_case)].max_row
        #                         fail_sheet_first_row = fail_sheet_max_row
        ...
        #             elif infor == case_translation_table1.get(mapping_case['second_case']):
        #                 sec_info_row = first_row_index[cur_test_case] + sec_test_case_count[cur_test_case]
        #                 sheet.cell(sec_info_row,detail_start_col+test_case_length[first_info]).value = time_item
        #                 if test_case_length[second_info] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col+test_case_length[first_info],detail_start_col+test_case_length[first_info],"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col+test_case_length[first_info],
        #                                       end_column=detail_start_col+test_case_length[first_info]+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col+test_case_length[first_info],detail_start_col+test_case_length[first_info],"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+test_case_length[first_info]+num+1,detail_start_col+test_case_length[first_info]+num+1,"5cb800")
        #                 test_case_length[second_info] = len(detail_items[test_case][infor])
        #                 sheet.cell(sec_info_row, detail_start_col+test_case_length[first_info]+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        #                             if key == fail_item_name:
        #                                 sheet.cell(sec_info_row, detail_start_col+test_case_length[first_info]+num+1).fill = PatternFill(start_color="e53b31", fill_type = "solid")
        #                             else:
        #                                 pass
        #                 # == test
        #                 if key == 'Result' and (val == 'fail' or val == 'warning'):
        ...
        #                             merge_row_title_for_sheet(card_info[a],wb['F-{}'.format(cur_test_case)],fail_sheet_max_row,1+a,fail_sheet_max_row,'FFFFFF')
        #                     elif fail_first_info_count == True:
        #                         set_title_for_sheet(infor,wb['F-{}'.format(cur_test_case)],1,fail_sheet_detail_start_col+test_case_length[first_info],fail_sheet_detail_start_col+test_case_length[first_info],"5cb800")
        #                         wb['F-{}'.format(cur_test_case)].merge_cells(start_row=1,end_row=1,start_column=fail_sheet_detail_start_col+test_case_length[first_info],end_column=fail_sheet_detail_start_col+test_case_length[first_info]+len(detail_items[test_case][infor]))
        #                         set_title_for_sheet('Time',wb['F-{}'.format(cur_test_case)],2,fail_sheet_detail_start_col+test_case_length[first_info],fail_sheet_detail_start_col+test_case_length[first_info],"5cb800")
        #                         fail_sheet_max_row = wb['F-{}'.format(cur_test_case)].max_row + 1
        #                         for i in range(len(infor_key)):
        #                             set_title_for_sheet(infor_key[i],wb['F-{}'.format(cur_test_case)],2,fail_sheet_detail_start_col+test_case_length[first_info]+i+1,fail_sheet_detail_start_col+test_case_length[first_info]+i+1,"5cb800")
        #                             wb['F-{}'.format(cur_test_case)].cell(fail_sheet_max_row,fail_sheet_detail_start_col+test_case_length[first_info]).value = time_item
        #                             wb['F-{}'.format(cur_test_case)].cell(fail_sheet_max_row, fail_sheet_detail_start_col+test_case_length[first_info]+i+1).value = infor_val[i]
        #                         for a in range(len(card_info)):
        #                             merge_row_title_for_sheet(card_info[a],wb['F-{}'.format(cur_test_case)],fail_sheet_max_row,1+a,fail_sheet_max_row,'FFFFFF')
        # elif ini_test_case == 'Qe1PortStatusEntry' or ini_test_case == 'FomStatusEntry':
        #     detail_start_col = 7
        #     cur_test_case = 'Card Port Status'
        #     if ini_test_case == 'FomStatusEntry':
        #         sec_test_case_count[cur_test_case] += 1
        #     else:
        #         test_case_count[cur_test_case] += 1
        #         row_index[cur_test_case] = sheet.max_row + 1
        #     if test_case_count[cur_test_case] == 1:
        #         first_row_index[cur_test_case] = row_index[cur_test_case] - 1
        #     data, fail_item = Card_Port_Status_parse(test_result[action_item][timecase_item],ini_test_case)
        #     detail_items[test_case] = data
        #     for num1,infor in enumerate(detail_items[test_case]):
        #         for num,(key, val) in enumerate(detail_items[test_case][infor].items()):
        #             if infor == 'QE1':
        #                 sheet.cell(row_index[cur_test_case],detail_start_col).value = time_item
        #                 if test_case_length['Qe1PortStatusEntry'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col,detail_start_col,"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col,end_column=detail_start_col+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col,detail_start_col,"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+num+1,detail_start_col+num+1,"5cb800")
        #                 test_case_length['Qe1PortStatusEntry'] = len(detail_items[test_case][infor]) + 1
        #                 sheet.cell(row_index[cur_test_case], detail_start_col+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        ...
        #             elif infor == 'FOM':
        #                 sec_info_row = first_row_index[cur_test_case] + sec_test_case_count[cur_test_case]
        #                 sheet.cell(sec_info_row,detail_start_col+test_case_length['Qe1PortStatusEntry']).value = time_item
        #                 if test_case_length['FomStatusEntry'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col+test_case_length['Qe1PortStatusEntry'],detail_start_col+test_case_length['Qe1PortStatusEntry'],"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col+test_case_length['Qe1PortStatusEntry'],
        #                                       end_column=detail_start_col+test_case_length['Qe1PortStatusEntry']+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col+test_case_length['Qe1PortStatusEntry'],detail_start_col+test_case_length['Qe1PortStatusEntry'],"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+test_case_length['Qe1PortStatusEntry']+num+1,detail_start_col+test_case_length['Qe1PortStatusEntry']+num+1,"5cb800")
        #                 test_case_length['FomStatusEntry'] = len(detail_items[test_case][infor])
        #                 sheet.cell(sec_info_row, detail_start_col+test_case_length['Qe1PortStatusEntry']+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        #                             if key == fail_item_name:
        #                                 sheet.cell(sec_info_row, detail_start_col+test_case_length['Qe1PortStatusEntry']+num+1).fill = PatternFill(start_color="e53b31", fill_type = "solid")
        #                             else:
        #                                 pass
        # elif ini_test_case == 'DpllPriStatusTable' or ini_test_case == 'DpllStandbyStatusTable':
        #     detail_start_col = 7
        #     cur_test_case = 'DPLL Status'
        #     if ini_test_case == 'DpllStandbyStatusTable':
        #         sec_test_case_count[cur_test_case] += 1
        #     else:
        #         test_case_count[cur_test_case] += 1
        #         row_index[cur_test_case] = sheet.max_row + 1
        #     if test_case_count[cur_test_case] == 1:
        #         first_row_index[cur_test_case] = row_index[cur_test_case] - 1
        #     data, fail_item = DPLL_Status_parse(test_result[action_item][timecase_item],ini_test_case)
        #     detail_items[test_case] = data
        #     for num1,infor in enumerate(detail_items[test_case]):
        #         for num,(key, val) in enumerate(detail_items[test_case][infor].items()):
        #             if infor == 'Working':
        #                 sheet.cell(row_index[cur_test_case],detail_start_col).value = time_item
        #                 if test_case_length['DpllPriStatusTable'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col,detail_start_col,"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col,end_column=detail_start_col+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col,detail_start_col,"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+num+1,detail_start_col+num+1,"5cb800")
        #                 test_case_length['DpllPriStatusTable'] = len(detail_items[test_case][infor]) + 1
        #                 sheet.cell(row_index[cur_test_case], detail_start_col+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        ...
        #             elif infor == 'Standby':
        #                 sec_info_row = first_row_index[cur_test_case] + sec_test_case_count[cur_test_case]
        #                 sheet.cell(sec_info_row,detail_start_col+test_case_length['DpllPriStatusTable']).value = time_item
        #                 if test_case_length['DpllStandbyStatusTable'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col+test_case_length['DpllPriStatusTable'],detail_start_col+test_case_length['DpllPriStatusTable'],"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col+test_case_length['DpllPriStatusTable'],
        #                                       end_column=detail_start_col+test_case_length['DpllPriStatusTable']+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col+test_case_length['DpllPriStatusTable'],detail_start_col+test_case_length['DpllPriStatusTable'],"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+test_case_length['DpllPriStatusTable']+num+1,detail_start_col+test_case_length['DpllPriStatusTable']+num+1,"5cb800")
        #                 test_case_length['DpllStandbyStatusTable'] = len(detail_items[test_case][infor])
        #                 sheet.cell(sec_info_row, detail_start_col+test_case_length['DpllPriStatusTable']+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        #                             if key == fail_item_name:
        #                                 sheet.cell(sec_info_row, detail_start_col+test_case_length['DpllPriStatusTable']+num+1).fill = PatternFill(start_color="e53b31", fill_type = "solid")
        #                             else:
        #                                 pass
        # elif ini_test_case == 'HdlcPriStatusTable' or ini_test_case == 'HdlcSecStatusTable':
        #     detail_start_col = 7
        #     cur_test_case = 'HDLC Status'
        #     if ini_test_case == 'HdlcSecStatusTable':
        #         sec_test_case_count[cur_test_case] += 1
        #     else:
        #         test_case_count[cur_test_case] += 1
        #         row_index[cur_test_case] = sheet.max_row + 1
        #     if test_case_count[cur_test_case] == 1:
        #         first_row_index[cur_test_case] = row_index[cur_test_case] - 1
        #     data, fail_item = HDLC_Status_parse(test_result[action_item][timecase_item],ini_test_case)
        #     detail_items[test_case] = data
        #     for num1,infor in enumerate(detail_items[test_case]):
        #         for num,(key, val) in enumerate(detail_items[test_case][infor].items()):
        #             if infor == 'Primary':
        #                 sheet.cell(row_index[cur_test_case],detail_start_col).value = time_item
        #                 if test_case_length['HdlcPriStatusTable'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col,detail_start_col,"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col,end_column=detail_start_col+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col,detail_start_col,"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+num+1,detail_start_col+num+1,"5cb800")
        #                 test_case_length['HdlcPriStatusTable'] = len(detail_items[test_case][infor]) + 1
        #                 sheet.cell(row_index[cur_test_case], detail_start_col+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        ...
        #                             else:
        #                                 pass
        #             elif infor == 'Secondary':
        #                 sec_info_row = first_row_index[cur_test_case] + sec_test_case_count[cur_test_case]
        #                 sheet.cell(sec_info_row,detail_start_col+test_case_length['HdlcPriStatusTable']).value = time_item
        #                 if test_case_length['HdlcSecStatusTable'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col+test_case_length['HdlcPriStatusTable'],detail_start_col+test_case_length['HdlcPriStatusTable'],"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col+test_case_length['HdlcPriStatusTable'],
        #                                       end_column=detail_start_col+test_case_length['HdlcPriStatusTable']+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col+test_case_length['HdlcPriStatusTable'],detail_start_col+test_case_length['HdlcPriStatusTable'],"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+test_case_length['HdlcPriStatusTable']+num+1,detail_start_col+test_case_length['HdlcPriStatusTable']+num+1,"5cb800")
        #                 test_case_length['HdlcSecStatusTable'] = len(detail_items[test_case][infor])
        #                 sheet.cell(sec_info_row, detail_start_col+test_case_length['HdlcPriStatusTable']+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
        #                             if key == fail_item_name:
        #                                 sheet.cell(sec_info_row, detail_start_col+test_case_length['HdlcPriStatusTable']+num+1).fill = PatternFill(start_color="e53b31", fill_type = "solid")
        #                             else:
        #                                 pass
        # elif ini_test_case == 'PwACRStatusEntry':
        #     detail_start_col = 7
        #     cur_test_case = 'PWACR Status'
        #     test_case_count[cur_test_case] += 1
        #     row_index[cur_test_case] = sheet.max_row + 1
        #     data, fail_item = PWACR_parse(test_result[action_item][timecase_item],ini_test_case)
        #     detail_items[test_case] = data
        #     for num1,infor in enumerate(detail_items[test_case]):
        #         for num,(key, val) in enumerate(detail_items[test_case][infor].items()):
        #             if infor == 'PWACR Status':
        #                 sheet.cell(row_index[cur_test_case],detail_start_col).value = time_item
        #                 if test_case_length['PwACRStatusEntry'] == 0:
        #                     set_title_for_sheet(infor,sheet,1,detail_start_col,detail_start_col,"5cb800")
        #                     sheet.merge_cells(start_row=1,end_row=1,start_column=detail_start_col,end_column=detail_start_col+len(detail_items[test_case][infor]))
        #                 set_title_for_sheet('Time',sheet,2,detail_start_col,detail_start_col,"5cb800")
        #                 set_title_for_sheet(key,sheet,2,detail_start_col+num+1,detail_start_col+num+1,"5cb800")
        #                 test_case_length['PwACRStatusEntry'] = len(detail_items[test_case][infor])+1
        #                 sheet.cell(row_index[cur_test_case], detail_start_col+num+1).value = val
        #                 for fail_key, fail_name in enumerate(fail_item):
        #                     if fail_name == infor:
        #                         for xnum,fail_item_name in enumerate(fail_item[fail_name]):
    ...
    for case in test_case_count:
        if case != 'Long Time Bert' and case != 'CTRL Bert':
            if test_case_count[case] == 0:
                ...
                if x == 0:
                    merge_row_title_for_sheet(cur_pass[x][case],wb[case],row_index[case]-test_case_count[case]+1,5,row_index[case],'FFFFFF')
                    if cur_fail[x][case] != 0:
                        merge_row_title_for_sheet(cur_fail[x][case],wb[case],row_index[case]-test_case_count[case]+1,6,row_index[case],'e53b31')
                        merge_row_title_for_sheet(cur_warning[x][case],wb[case],row_index[case]-test_case_count[case]+1,7,row_index[case],'FFFFFF')
                    elif cur_warning[x][case] != 0:
                        merge_row_title_for_sheet(cur_warning[x][case],wb[case],row_index[case]-test_case_count[case]+1,7,row_index[case],'f5bf1a')
                        merge_row_title_for_sheet(cur_fail[x][case],wb[case],row_index[case]-test_case_count[case]+1,6,row_index[case],'FFFFFF')
                    else:
                        merge_row_title_for_sheet(cur_fail[x][case],wb[case],row_index[case]-test_case_count[case]+1,6,row_index[case],'FFFFFF')
                        merge_row_title_for_sheet(cur_warning[x][case],wb[case],row_index[case]-test_case_count[case]+1,7,row_index[case],'FFFFFF')
                else:
                    merge_row_title_for_sheet(cur_pass[x][case]-cur_pass[x-1][case],wb[case],row_index[case]-test_case_count[case]+1,5,row_index[case],'FFFFFF')
                    if cur_fail[x][case]-cur_fail[x-1][case] != 0:
                        merge_row_title_for_sheet(cur_fail[x][case]-cur_fail[x-1][case],wb[case],row_index[case]-test_case_count[case]+1,6,row_index[case],'e53b31')
                        merge_row_title_for_sheet(cur_warning[x][case]-cur_warning[x-1][case],wb[case],row_index[case]-test_case_count[case]+1,7,row_index[case],'FFFFFF')
                    elif cur_warning[x][case]-cur_warning[x-1][case] != 0:
                        merge_row_title_for_sheet(cur_warning[x][case]-cur_warning[x-1][case],wb[case],row_index[case]-test_case_count[case]+1,7,row_index[case],'f5bf1a')
                        merge_row_title_for_sheet(cur_fail[x][case]-cur_fail[x-1][case],wb[case],row_index[case]-test_case_count[case]+1,6,row_index[case],'FFFFFF')
                    else:
                        merge_row_title_for_sheet(cur_fail[x][case]-cur_fail[x-1][case],wb[case],row_index[case]-test_case_count[case]+1,6,row_index[case],'FFFFFF')
                        merge_row_title_for_sheet(cur_warning[x][case]-cur_warning[x-1][case],wb[case],row_index[case]-test_case_count[case]+1,7,row_index[case],'FFFFFF')
    ...
    if item in category_exist:
        ...
        for x_s, item_s in enumerate(list(test_category[item].keys())):
            if test_category[item][item_s] != {}:
                if test_category[item][item_s]['pass'] != 0 or test_category[item][item_s]['fail'] !=0 or \
